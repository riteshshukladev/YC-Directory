    ...
    <>
      ...
      {editorPosts?.length > 0 && (
        <div className="max-w-4xl mx-auto">
          <p className="text-30-semibold">Editor pucks</p>

          <ul className="mt-7 card_grid_sm max-w-4xl">
            {editorPosts.map((editpost: StartupTypeCard, i: number) => (
              <StartupCard key={i} post={editpost} />
            ))}
          </ul>
        </div>
      )}
